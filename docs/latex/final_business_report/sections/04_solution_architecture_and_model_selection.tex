...
\begin{table}[bp]
\centering
\caption{Macro-averaged performance across all 15 MVTec AD categories under the \texttt{fair-eval-v1} protocol. PatchCore ResNet-18 constitutes the production-grade reference configuration.}
