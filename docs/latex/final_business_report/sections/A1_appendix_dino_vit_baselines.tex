...
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{DINOv2 (ViT-S/14, frozen):} Patch-level cosine nearest-neighbour matching against an empirical memory bank of frozen self-supervised ViT patch tokens, pre-trained via discriminative self-distillation on the curated LVD-142M dataset \cite{oquab2023dinov2}.
