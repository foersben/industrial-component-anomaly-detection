...
\begin{columns}[T]
  ...
  \begin{column}{0.50\textwidth}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.34\textheight,keepaspectratio]{binarization_threshold_aupimo.png}\\[-2pt]
    {\tiny\color{muted} Threshold tradeoff curve \& AUPIMO range}\\[3pt]
    \includegraphics[width=0.95\textwidth,height=0.34\textheight,keepaspectratio]{pr_curve_aupimo.png}\\[-2pt]
