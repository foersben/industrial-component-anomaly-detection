...
adapted from the masked-restoration technique developed for our
best-performing bottle autoencoder (Section~\ref{sec:ae2}): random patches were zeroed
and the model was trained to restore the full image. This failed decisively
